    ...
    <section className="dashboard" id="top">
      ...
      <section className="data-center" aria-labelledby="data-center-title">
        ...
        <div className="data-tools">
          <article className="data-tool pdf-tool"><span className="tool-icon">PDF</span><div><h3>Broker-Abrechnungen importieren</h3><p>Text-PDFs für Käufe, Verkäufe, Dividenden, Steuern, Gebühren und Depotüberträge einlesen. Bestandswirksame Belege werden automatisch für den OeKB-Meldetag berücksichtigt.</p><label className="file-action primary-file">PDFs auswählen<input type="file" accept="application/pdf,.pdf" multiple onChange={(event) => { void importBrokerPdfs(event.target.files); event.target.value = ""; }} /></label></div><em>Mit Portfolio-Performance-Belegen geprüft: Flatex-Einzelabrechnungen, Trade Republic, Scalable/Baader, DEGIRO, DADAT, DKB, ING, comdirect, Consorsbank, onvista, easybank, Raiffeisen und Erste. Nicht unterstützt: Scans und Flatex-Sammelabrechnungen aus Zahlungsplänen.</em></article>
